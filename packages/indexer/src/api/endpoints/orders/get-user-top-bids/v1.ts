  ...
  handler: async (request: Request) => {
    ...
    try {
      const baseQuery = `
        ...
        LEFT JOIN LATERAL (
            SELECT t.token_id, COALESCE(t.metadata_version::TEXT, t.image_version::TEXT) AS image_version, t.name, t.image, t.collection_id, floor_sell_value AS "token_floor_sell_value", last_sell_value AS "token_last_sell_value"
            FROM tokens t
